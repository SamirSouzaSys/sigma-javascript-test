...
function createImmutableObject<T extends object>(inputObject: T): T {
...
const myObject1 = createImmutableObject(
    { foo: 'bar', foo2: 'bar2' }
);

// Attempting to modify the object
(myObject1 as any).foo = null;
(myObject1 as any).property = "I can add new fields";
